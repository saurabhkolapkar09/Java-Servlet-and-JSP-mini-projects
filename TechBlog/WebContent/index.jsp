...
<!-- these css files are  taken from bootstrap  -->
...
<!-- below css is taken from "css clip path maker Bennett feely" website -->
...
<body>
	...
	<div class="container-fluid p-0 m-0">
		<div class="jumbotron primary-background text-white banner-background">
			<div class="container ">
				<h3 class="display-3">Welcome to Tech Courses</h3>
	...
	<%-- <%
Connection con = com.tech.blog.helper.ConnectionProvider.getConnection();
%>
<h1><%= con %></h1>
 ...
 --%>
	...
	<!--this script is taken from "jQuery cdn" page  -->
...
<!-- these two scripts are taken from bootstrap website -->
